...
public class Menu {
    ...
    public Menu() {
        ...
        this.second_menu_list.put(2, new MenuItem("Options", "Options","LastItem"));
        ...
        this.first_menu_list.put(1, new MenuItem("Parameters", "Parameters", "Next").withChildren(this.second_menu_list));
        this.first_menu_list.put(2, new MenuItem("Gallery", "Gallery", "Next"));
        this.first_menu_list.put(3, new MenuItem("Settings", "Settings", "Next"));
